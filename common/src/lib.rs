...
impl Actions {
    pub async fn web_action_dispatch_workflow(req: DispatchReq) -> DispatchRes {
        let req_uri: String = String::from("http://localhost:7071/api/nxfutil/dispatch?whatif=true");
